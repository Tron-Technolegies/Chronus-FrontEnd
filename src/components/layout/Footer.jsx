...
const Footer = () => {
  return (
    <footer className="bg-[#1a0806] pt-12 relative flex flex-col items-center overflow-hidden inter  text-[#FFEDD0]">
      <div className="w-[92%] max-w-[1400px] bg-[#2a0e0c] rounded-[40px]  p-8 md:p-12 lg:p-16 relative z-10 border border-[#78241e5d] shadow-2xl shadow-[#541a1685]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <img src="/chronus-logo.png" alt="Chronos" className="h-7 w-auto object-contain" />
          ...
          <div className="lg:pl-10 text-[#d4bca9] ">
            <h3 className="font-semibold mb-6 uppercase tracking-wider text-sm">Collections</h3>
          ...
          <div className="text-[#d4bca9]">
            <h3 className="font-semibold mb-6 uppercase tracking-wider text-sm">Services</h3>
            <ul className="space-y-3 text-sm opacity-70">
          ...
          <div className="text-[#d4bca9]">
            <h3 className="font-semibold mb-6 uppercase tracking-wider text-sm">Contact Us</h3>
      ...
      <div className="relative w-full max-w-[1150px] z-0 px-4 pt-4 md:pt-10 select-none pointer-events-none">
        <img
          ...
          className="w-full h-auto block mt-[-60px] md:mt-[-90px] lg:mt-[-10px] opacity-20 mix-blend-screen"
          draggable="false"
        />
      </div>
    </footer>
