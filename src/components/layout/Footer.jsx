...
const Footer = () => {
  return (
    <footer
      className="bg-[#1a0806] pt-10 sm:pt-14 md:pt-16 relative flex flex-col items-center overflow-hidden inter text-[#FFEDD0]"
      id="contact"
    >
      <div className="w-[94%] sm:w-[92%] max-w-[1400px] bg-[#2a0e0c] rounded-[22px] sm:rounded-[36px] md:rounded-[40px] px-5 py-8 sm:px-8 sm:py-10 md:px-12 md:py-14 lg:px-16 lg:py-16 relative z-10 border border-[#78241e5d] shadow-2xl shadow-[#541a1685]">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr] gap-10 md:gap-12 mb-10 sm:mb-14">
          ...
          <div className="space-y-5">
            ...
            <p className="text-[#d4bca9]/70 text-sm leading-relaxed max-w-[280px]">
            ...
            <div className="flex gap-3 flex-wrap">
              {SOCIALS.map(({ Icon, href, label }) => (
                <a
                  ...
                  rel="noreferrer"
                  aria-label={label}
                  className="w-9 h-9 rounded-full bg-[#1a0806] flex items-center justify-center text-[#d4bca9] hover:bg-[#d4bca9] hover:text-[#1a0806] transition-all duration-200"
                >
                  <Icon size={15} />
                </a>
              ))}
          ...
          {/* Collections */}
          <div className="text-[#d4bca9] sm:pl-4 lg:pl-10">
        ...
        {/* Bottom bar */}
        <div className="pt-6 sm:pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[#d4bca9]/50 text-[10px] sm:text-[11px] uppercase tracking-[0.15em] sm:tracking-[0.2em] text-center">
