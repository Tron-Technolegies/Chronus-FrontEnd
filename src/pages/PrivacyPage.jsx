...
const PrivacyPage = () => {
  ...
  const sections = t('policies.privacy.sections', { returnObjects: true }) || [];
    ...
    <div className="min-h-screen bg-[#1a0806] text-[#FFEDD0] inter pt-24 pb-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-[#FFEDD0] mb-4">{t('policies.privacy_title')}</h1>
          <p className="text-[#d4bca9]/60 text-sm">{t('policies.last_updated')}</p>
        </div>
        ...
        <div className="mt-10 flex gap-6 text-[10px] uppercase tracking-[0.2em] text-[#d4bca9]/40">
          <Link to="/shipping" className="hover:text-[#d4bca9] transition-colors">{t('policies.shipping_title')}</Link>
