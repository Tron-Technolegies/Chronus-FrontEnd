...
const ShippingPage = () => {
  ...
  const sections = t('policies.shipping.sections', { returnObjects: true }) || [];
    ...
    <div className="min-h-screen bg-[#1a0806] text-[#FFEDD0] inter pt-24 pb-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-[#FFEDD0] mb-4">{t('policies.shipping_title')}</h1>
